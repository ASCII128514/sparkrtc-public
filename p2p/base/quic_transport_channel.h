...
#ifndef P2P_BASE_QUIC_TRANSPORT_CHANNEL_H_
#define P2P_BASE_QUIC_TRANSPORT_CHANNEL_H_
...
// QuicTransportChannel implements a transport channel using Google's QUIC protocol.
// This channel can be used for signaling and data transfer in WebRTC.
class QuicTransportChannel : public IceTransportInternal,
                             public webrtc::DataChannelTransportInterface,
                             public sigslot::has_slots<> {
 public:
  // Factory method to create a QuicTransportChannel.
  static std::unique_ptr<QuicTransportChannel> Create(
 ...
 private:
  QuicTransportChannel(absl::string_view transport_name,
                      int component,
                      PortAllocator* allocator);
...
#endif  // P2P_BASE_QUIC_TRANSPORT_CHANNEL_H_